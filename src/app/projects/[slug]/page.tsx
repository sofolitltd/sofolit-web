      ...
      <div className="container px-4 mx-auto">
        ...
        <section className="py-24 text-center space-y-8 border-t border-border">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4">
            ...
            <Link href="/projects" className="px-10 py-4 rounded-full border border-border bg-background font-bold hover:bg-muted transition-all flex items-center justify-center">
              See More Projects
            </Link>
          </div>
        </section>
