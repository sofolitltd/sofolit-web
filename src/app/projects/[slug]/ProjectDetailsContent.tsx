...
export function ProjectDetailsContent({ study }: ProjectDetailsContentProps) {
      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-32">
          <div className="lg:col-span-8 space-y-20">
            ...
            <section className="space-y-8 p-12 rounded-2xl bg-muted/30 border border-border">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-xl bg-green-500/10 flex items-center justify-center border border-green-500/20">
                  <Trophy className="w-6 h-6 text-green-500" />
                </div>
                <h2 className="text-3xl font-black">Key Features & Impact</h2>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {(study.results || study.keyFeatures).map((feature, i) => (
          ...
          <aside className="lg:col-span-4 space-y-8">
            <div className="p-8 rounded-2xl glass-card border-border sticky top-32">
              <h3 className="text-xl font-black mb-6">Technologies</h3>
              <div className="flex flex-wrap gap-2 mb-10">
                {study.tags.map(tech => (
                  <span key={tech} className="px-4 py-2 rounded-lg bg-primary/10 text-primary text-xs font-bold border border-primary/20">
                    {tech}
                  </span>
                ))}
              </div>
              ...
              <a 
                ...
                className="w-full py-4 rounded-xl bg-primary text-white font-black flex items-center justify-center gap-2 hover:shadow-xl transition-all"
              >
